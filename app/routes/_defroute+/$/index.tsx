...
export default function NotFound() {
  ...
  return (
    <section className="relative flex flex-col justify-center py-6 px-4 sm:px-6 lg:px-8 overflow-hidden">
      <div className="w-full flex flex-col items-center text-center relative z-10 space-y-4 sm:space-y-5">
        ...
        <div className="flex flex-col sm:flex-row gap-2 pt-4 sm:pt-6">
          ...
          >
            ...
            <span className="relative z-10">{t('errors.not_found.buttonText')}</span>
          </Link>
        </div>
      </div>
    </section>
